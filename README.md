...
Symptome werden nicht korrekt erkannt, seit gestern ist kein Symptom. Das kann z.B. mit einer Variable "Zeiteinordnung" und einer Abgrenzung im Prompt verbessert werden
...
use more features of mastra such as caching to improve response time for real world use and configure persistent storage adapter
